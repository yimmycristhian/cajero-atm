...
public class Cajero extends javax.swing.JFrame {
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        String nombre = JOptionPane.showInputDialog(null, "Ingrese su nombre: ", "Ingresar", JOptionPane.INFORMATION_MESSAGE);
        if (!validar(nombre.trim())) {
            JOptionPane.showMessageDialog(null, "Solo letras y sin espacios!", "Error", JOptionPane.ERROR_MESSAGE);
        } else {
            txNombre.setText(nombre);
            //Deshabilito el boton
            btnIngresar.setEnabled(false);
            // Habilito los siguientes botones
